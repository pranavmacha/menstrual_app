    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _TableCard(
            headers: const ['Iron source', 'Type', 'Absorption tips'],
            rows: const [
              [
                'Beef, chicken liver, seafood',
                'Heme iron (animal-based)',
                'Absorbs easily—pair with fiber-rich sides for balance.',
              ],
              [
                'Spinach, lentils, beans, tofu',
                'Non-heme iron (plant-based)',
                'Combine with vitamin C (citrus, bell peppers) to boost absorption.',
              ],
            ],
          ),
          const SizedBox(height: 16),
